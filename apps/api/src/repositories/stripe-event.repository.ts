 ...
 */
export async function getStripeEventById(id: number | string): Promise<StripeEvent | null> {
 ...
 */
export async function createStripeEvent(data: Prisma.StripeEventCreateInput): Promise<StripeEvent> {
 ...
 */
export async function deleteStripeEvent(id: number | string): Promise<StripeEvent> {
