        ...
        <section className={styles.comparisonSection}>
            <div className={styles.container}>
                        ...
                        <tbody>
                            {data.map((row, index) => (
                                <tr key={index} className={styles.dataRow}>
                                    ...
                                    <td
                                        className={`${styles.dataCell} ${getCellClass(
                                            row.free,
                                            {
                ...
                <p className={styles.notes}>
                    <strong>Notes:</strong> Active = Running + Paused. The
                    engine blocks new starts when the quota is reached. One
                    instrument per session. No session continuation while away
