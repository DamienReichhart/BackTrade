...
export function Terms() {
  return (
    <div>
      ...
      <LegalPageLayout title="Terms of Service" lastUpdated="October 28, 2025">
        <h2>1. Acceptance of Terms</h2>
        <p>
          By accessing and using BackTrade ("the Service"), you accept and agree
          to be bound by the terms and provision of this agreement. If you do
          not agree to abide by the above, please do not use this service.
        </p>

        <h2>2. Description of Service</h2>
        <p>BackTrade is a comprehensive trading platform that provides:</p>
        <ul>
        ...
        <p>
          ...
          and will remain the exclusive property of BackTrade and its licensors.
        ...
        <p>
          Some features of the Service require a paid subscription. Subscription
          fees are billed in advance on a monthly or annual basis and are
        ...
        <p>
          ...
          will be communicated to users at least 30 days in advance.
        </p>

        <h2>8. Disclaimers</h2>
        <p>
          The information on this Service is provided on an "as is" basis. To
          the fullest extent permitted by law, BackTrade:
        </p>
        <ul>
          <li>
          ...
          <li>
            Is not responsible for trading losses or investment decisions made
            based on our data
          </li>
        </ul>
        ...
        <p>
          You agree to defend, indemnify, and hold harmless BackTrade and its
