...
export function Privacy() {
  return (
    <div>
      ...
      <LegalPageLayout title="Privacy Policy" lastUpdated="October 28, 2025">
        <h2>1. Introduction</h2>
        <p>
          BackTrade ("we," "our," or "us") is committed to protecting your
          privacy. This Privacy Policy explains how we collect, use, disclose,
          and safeguard your information when you use our trading platform and
          related services.
        </p>
        ...
        <ul>
          <li>
            ...
            improve our trading platform
          </li>
          <li>
            <strong>Account Management:</strong> To create and manage your
            account and authenticate your identity
          </li>
          <li>
        ...
        <p>You can manage your communication preferences by:</p>
        <ul>
        ...
        <p>
          ...
          You can control cookie preferences through your browser settings, but
