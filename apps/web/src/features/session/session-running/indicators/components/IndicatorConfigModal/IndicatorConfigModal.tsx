                ...
                <header className={styles.header}>
                    <div>
                        ...
                        <p className={styles.subtitle}>
                            Add, reorder, and configure overlays and oscillators
                            for the running session chart. All changes persist
                        ...
                        <div className={styles.cardStack}>
                            {indicators.length === 0 ? (
                                <p className={styles.emptyState}>
                                    No indicators yet. Add one from the list
                                    below.
                                </p>
                            ) : (
                                indicators.map((indicator, index) => (
                                    <IndicatorCard
                                        ...
                                        isSelected={
                                            indicator.id === derivedSelectedId
                                        }
                                        canMoveUp={index > 0}
                                        canMoveDown={
                                        ...
                                        onMoveUp={() =>
                                            reorderIndicator(indicator.id, "up")
                                        }
                                        onMoveDown={() =>
                                            reorderIndicator(
                                                indicator.id,
                    ...
                    <section className={styles.formPane}>
                        {selectedIndicator && selectedDefinition ? (
                            ...
                            <div className={styles.placeholder}>
                                <p>
                                    Select an indicator to edit its
                                    configuration.
                                </p>
                            </div>
                        )}
