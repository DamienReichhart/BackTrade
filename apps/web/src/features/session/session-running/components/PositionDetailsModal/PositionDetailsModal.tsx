        ...
        <div className={styles.content}>
          <div className={styles.section}>
            <div className={styles.row}>
              ...
              <span className={styles.value}>{position.position_status}</span>
            </div>
            <div className={styles.row}>
            ...
            <div className={styles.row}>
              <span className={styles.label}>Take Profit (TP):</span>
              <span className={styles.value}>{position.tp_price ?? "-"}</span>
            </div>
            <div className={styles.row}>
              <span className={styles.label}>Stop Loss (SL):</span>
              <span className={styles.value}>{position.sl_price ?? "-"}</span>
            </div>
            {position.opened_at && (
              <div className={styles.row}>
          ...
          {position.closed_at && (
            <div className={styles.section}>
              <div className={styles.row}>
                <span className={styles.label}>Closed Price:</span>
                <span className={styles.value}>
                  {position.exit_price ?? "-"}
                </span>
              </div>
              <div className={styles.row}>
                <span className={styles.label}>Closed Time:</span>
                <span className={styles.value}>
