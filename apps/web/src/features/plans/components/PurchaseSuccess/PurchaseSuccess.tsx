    ...
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <p className={styles.message}>
          Your subscription to the <strong>{planCode.toUpperCase()}</strong>{" "}
        ...
        {plan?.currency && plan.price !== undefined && (
          <div className={styles.planInfo}>
            <div className={styles.planDetail}>
              ...
              <span className={styles.planValue}>{planCode.toUpperCase()}</span>
            </div>
            <div className={styles.planDetail}>
        ...
        <div className={styles.actions}>
          <Button variant="primary" size="large" onClick={handleViewPlans}>
            View My Plans
          </Button>
          <Button variant="outline" size="large" onClick={handleGoToDashboard}>
            Go to Dashboard
          </Button>
        </div>
      </div>
