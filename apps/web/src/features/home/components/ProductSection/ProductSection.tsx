...
const productFeatures: ProductFeature[] = [
  {
    ...
    description: "Single-instrument sessions bound to instrument and start time. Own balance, equity, and margin.",
    features: ["OHLCV bars • UTC clock • step or skip"],
  },
  {
    id: "immediate-execution",
    title: "Immediate execution",
    description: "Open Long or Short at the simulated mark. Optional TP/SL. Manage Close and Close-At.",
    features: ["Market only • no pending orders"],
  },
  {
    id: "reporting",
    title: "Reporting",
    description: "Per-session summary, equity curve, drawdowns, and exports. Net PnL and expectancy per trade.",
