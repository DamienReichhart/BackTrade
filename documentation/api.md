...
| **User**                      | `{ id: number, email: string, role: Role, is_banned: boolean, stripe_customer_id?: string, created_at: string, updated_at: string }`                                                                                                                                                                                                                                   | Full user entity                      |
...
| **Session**                   | `{ id: number, user_id: number, instrument_id: number, name?: string, session_status: SessionStatus, speed: Speed, start_ts: string, current_ts: string, end_ts?: string, initial_balance: number, leverage: Leverage, spread_pts: number, slippage_pts: number, commission_per_fill: number, created_at: string, updated_at: string }`                                | Trading session entity                |
| **CreateSessionRequest**      | `{ instrument_id: number, name?: string, speed: Speed, start_ts: string, current_ts: string, end_ts?: string, initial_balance: number, leverage: Leverage, spread_pts: number, slippage_pts: number, commission_per_fill: number, user_id: number, session_status: SessionStatus, created_at: string, updated_at: string }`                                            | Payload to create a session           |
| **UpdateSessionRequest**      | `{ name?: string, session_status?: SessionStatus, speed?: Speed, current_ts?: string, end_ts?: string }`                                                                                                                                                                                                                                                               | Payload to update a session           |
...
| **Transaction**               | `{ id: number, user_id: number, session_id?: number, position_id?: number, transaction_type: TransactionType, amount: number, balance_after: number, created_at: string, updated_at: string }`                                                                                                                                                                         | Financial transaction entity          |
| **CreateTransactionRequest**  | `{ user_id: number, session_id?: number, position_id?: number, transaction_type: TransactionType, amount: number, balance_after: number }`                                                                                                                                                                                                                             | Payload to create a transaction       |
...
| **Dataset**                   | `{ id: number, instrument_id: number, timeframe: Timeframe, uploaded_by_user_id: number, uploaded_at?: string, records_count?: number, file_name?: string, is_active: boolean, start_ts?: string, end_ts?: string, created_at: string, updated_at: string }`                                                                                                           | Dataset entity                        |
| **CreateDatasetRequest**      | `{ instrument_id: number, timeframe: Timeframe }`                                                                                                                                                                                                                                                                                                                      | Payload to create a dataset           |
| **UpdateDatasetRequest**      | `{ start_date?: string, end_date?: string, is_active?: boolean }`                                                                                                                                                                                                                                                                                                      | Payload to update a dataset           |
...
| **AuditLog**                  | `{ id: number, user_id: number, entity_type: EntityType, entity_id: string, audit_action: AuditAction, details: Record<string, unknown>, ip_address: string, user_agent: string, created_at: string }`                                                                                                                                                                 | Audit log entity                      |
...
| **GET**    | `/audit-logs`                | -                             | -                           | `AuditLog[]`     | 200, 401, 403                | List audit logs (Admin)              |
