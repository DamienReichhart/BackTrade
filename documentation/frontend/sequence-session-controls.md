...
sequenceDiagram
    ...
    alt Validation fails
        ...
        Note over API: Request body contains<br/>updated fields (status, speed, current_time, etc.)
    ...
    Note over User,useSessionData: Other controls follow same pattern:<br/>- SpeedSelector: Updates speed_multiplier<br/>- SkipBarButton: Increments current_time<br/>- CloseAllButton: POST /positions/close-all<br/>- ArchiveButton: Sets status to ARCHIVED
```
